...
import { Data as Lifting, Item as LiftingItem } from '@/lib/typeLifting';
import {
  Data as Extinguisher,
  Item as ExtinguisherItem,
} from '@/lib/typeExtinguisher';
import { Data as Hydrant, Item as HydrantItem } from '@/lib/typeHydrant';
import { Data as Foam, Item as FoamItem } from '@/lib/typeFoam';
import { Data as Pump, Item as PumpItem } from '@/lib/typePump';
import { Data as Valve, Item as ValveItem } from '@/lib/typeValve';
import { Data as Forklift, Item as ForkliftItem } from '@/lib/typeForklift';
import { Data as Mobile, Item as MobileItem } from '@/lib/typeMobile';
import { Data as Vehicle, Item as VehicleItem } from '@/lib/typeVehicle';
import { Data as Harness, Item as HarnessItem } from '@/lib/typeHarness';
import { Data as Portable, Item as PortableItem } from '@/lib/typePortable';
import { Data as Lifeline, Item as LifelineItem } from '@/lib/typeLifeline';
...
export const columns = (
  ...
  calculateDefectPercentage: (inspection: MachineItem) => number,
  toggleExpanded: () => void,
  expanded: boolean,
  item: string,
  handleShowForm: (id: string | undefined, machine: string) => void,
  handleEditEquipment: (id: string | undefined, machine: string) => void
): ColumnDef<Machine>[] => [
  {
    accessorKey: 'id',
    header: ({ column }) => {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div
          className="font-medium text-rose-500 hover:font-bold cursor-pointer"
          onClick={() => handleEditEquipment(id, machine)}
        >
          {id}
        </div>
      );
