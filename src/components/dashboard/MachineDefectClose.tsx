...
import MachineDefectClose1 from './MachineDefectClose1';
  ...
  return (
    <div className="flex flex-col gap-2 items-center w-full">
      <div className="flex justify-center my-4">
        <QRCodeSVG
          value="https://sccvn-zzlewmt.mongodbstitch.com/MachineDefectClose"
          size={75}
          bgColor="#ffffff"
          fgColor="#000000"
          level="L"
      ...
      <h1 className="text-green-600 font-bold text-4xl animate-pulse">
        Defect Close
      </h1>
