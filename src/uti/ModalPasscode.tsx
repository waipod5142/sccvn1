    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
      <div className="bg-white p-6 rounded shadow-lg w-80">
        ...
        <p className="p-4 bg-white rounded-lg shadow-md text-xs">
          ...
          <br />
          1. โครงการนี้สำหรับพนักงาน SCCC และ SCP
          ที่ประจำที่โรงงานสระบุรีเท่านั้น (อ้างอิงข้อมูลตามรายชื่อพนักงาน
          เดือนกุมภาพันธ์ 2568)
          <br />
          2. โครงการนี้มีระยะเวลาตั้งแต่ 14 กุมภาพันธ์ ถึง 31 ธันวาคม 2568
          เท่านั้น
          <br />
          3. พนักงานจะได้คูปองค่าอาหาร (Token) 40 บาทต่อคน ต่อวันทำงาน
          ใช้ได้ที่ร้านจำหน่ายอาหารภายในสโมสรโรงงาน 1, 2, 3 ครัวบ้านเรา เท่านั้น
          (ไม่มีการสะสมยอด)
          <br />
          4. บริษัทขอสงวนสิทธิในการเปลี่ยนแปลง แก้ไข ยกเลิก
